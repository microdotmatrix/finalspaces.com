...
type CalendarRootProps = ComponentProps<"div"> & {
...
function CalendarChevron({ className, orientation }: CalendarChevronProps) {
  if (orientation === "left") {
    return <CaretLeftIcon className={cn("size-4", className)} />;
  }

  if (orientation === "right") {
    return <CaretRightIcon className={cn("size-4", className)} />;
  }

  if (orientation === "up") {
    return <CaretDownIcon className={cn("size-4 rotate-180", className)} />;
  }

  return <CaretDownIcon className={cn("size-4", className)} />;
}
