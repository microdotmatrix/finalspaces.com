...
this project uses Shadcn with Base UI components - **NOT** Radix UI. please consult Base UI documentation for implementation and usage of all components in src/components/ui directory.

project does **NOT** use React Hook Form or Tanstack Form libraries. use native form element.
